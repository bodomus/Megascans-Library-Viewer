...
public sealed record AssetParseResult(
    AssetParseStatus Status,
...
public sealed record DuplicateAssetGroup(
    string AssetId,
    string WinnerJsonPath,
    IReadOnlyList<string> SkippedCopyJsonPaths);
